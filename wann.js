/** 
 - Create By Iusz
 - Contact Me on https://wa.me/+6285817414657
 - Follow iG : Gaada coeg
...
module.exports = wann = async (wann, m, chatUpdate, store) => {
try {
...
if (multipref) {
   var prefix = /^[°•π÷×¶∆£¢€¥®™✓_=|~!?#$%^&.+-,\/\\©^]/.test(body) ? body.match(/^[°•π÷×¶∆£¢€¥®™✓_=|~!?#$%^&.+-,\/\\©^]/gi) : '#'
    ...
    prefix = preff
        ...
        const ads = (teks) => {
wann.sendMessage(from, { text : teks, contextInfo: {"externalAdReply": { title: "WHASTAPP BOT",mediaType: 3,renderLargerThumbnail: false, showAdAttribution: true, body: "🤫",thumbnail: fs.readFileSync('./Image/wpmobile.png'),sourceUrl: "https://www.instagram.com/p/CdE0RPbDRXi/?igshid=YmMyMTA2M2Y="}}})
}
...
wann.sendMessage(from, { text: sendResponList(from, body, db_respon_list) }, {
quoted: m
})
} else {
wann.sendMessage(from, { image: await getBuffer(get_data_respon.image_url), caption: get_data_respon.response }, {
quoted: m
})
}
}
...
// auto set bio
	if (db.data.settings[botNumber].autobio) {
		...
		await wann.setStatus(`${wann.user.name} | Runtime : ${runtime(uptime)}`)
		...
		try {
        ppuser = await wann.profilePictureUrl(m.sender, 'image')
        } catch (err) {
...
img: await resz.getBufferAsync(jimp.MIME_JPEG)
        ...
        const sendFileFromUrl = async (from, url, caption, m, men) => {
            ...
            if (mime.split("/")[1] === "gif") {
                return wann.sendMessage(from, { video: await getBuffer(url), caption: caption, gifPlayback: true, mentions: men ? men : [], mimetype: 'video/mp4'}, {quoted: m})
                }
            let type = mime.split("/")[0]+"Message"
            if(mime === "application/pdf"){
                return wann.sendMessage(m.chat, { document: await getBuffer(url), mimetype: 'application/pdf', caption: caption, mentions: men ? men : []}, {quoted: m })
            }
            if(mime.split("/")[0] === "image"){
                return wann.sendMessage(m.chat, { image: await getBuffer(url), caption: caption, mentions: men ? men : []}, {quoted: m})
            }
            if(mime.split("/")[0] === "video"){
                return wann.sendMessage(m.chat, { video: await getBuffer(url), caption: caption, mentions: men ? men : [], mimetype: 'video/mp4'}, {quoted: m })
            }
            if(mime.split("/")[0] === "audio"){
                return wann.sendMessage(m.chat, { audio: await getBuffer(url), caption: caption, mentions: men ? men : [], mimetype: 'audio/mpeg'}, {quoted: m })
            }
        }
        ...
        wann.sendMessage(m.chat, { text : teks, mentions: await wann.parseMention(teks), contextInfo : {
        "forwardingScore":999,
        "isForwarded":true, 
...
thumbnail: ppnyauser, 
surface: 200, 
message: `Â© ${global.namaownernya}`,
token: "AR40+xXRlWKpdJ2ILEqtgoUFd45C8rc1CMYdYG/R2KXrSg==",
totalAmount1000: "500000000000000",
totalCurrencyCode: "IDR",
orderTitle: `Haiii ${ngazap(prefix)}`,
...
sendEphemeral: true}
        ...
        const sticWait = (hehe) => {
			...
			wann.sendMessage(hehe, { sticker: ano, contextInfo: {
			forwardingScore:999,
            isForwarded:true, 
            mentionedJid: [m.sender],
			externalAdReply: { 
        ...
        if (tebaklagu.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await wann.sendButtonText(m.chat, [{ buttonId: 'tebak lagu', buttonText: { displayText: 'Tebak Lagu' }, type: 1 }], `🎮 Tebak Lagu 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, wann.user.name, m)
        ...
        if (tebakgambar.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await wann.sendButtonText(m.chat, [{ buttonId: 'tebak gambar', buttonText: { displayText: 'Tebak Gambar' }, type: 1 }], `🎮 Tebak Gambar 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, wann.user.name, m)
        ...
        if (tebakkata.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await wann.sendButtonText(m.chat, [{ buttonId: 'tebak kata', buttonText: { displayText: 'Tebak Kata' }, type: 1 }], `🎮 Tebak Kata 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, wann.user.name, m)
	    ...
	    deskripsi = caklontong_desk[m.sender.split('@')[0]]
            if (budy.toLowerCase() == jawaban) {
                await wann.sendButtonText(m.chat, [{ buttonId: 'tebak lontong', buttonText: { displayText: 'Tebak Lontong' }, type: 1 }], `🎮 Cak Lontong 🎮\n\nJawaban Benar 🎉\n*${deskripsi}*\n\nIngin bermain lagi? tekan button dibawah`, wann.user.name, m)
        ...
        if (tebakkalimat.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await wann.sendButtonText(m.chat, [{ buttonId: 'tebak kalimat', buttonText: { displayText: 'Tebak Kalimat' }, type: 1 }], `🎮 Tebak Kalimat 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, wann.user.name, m)
        ...
        if (tebaklirik.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await wann.sendButtonText(m.chat, [{ buttonId: 'tebak lirik', buttonText: { displayText: 'Tebak Lirik' }, type: 1 }], `🎮 Tebak Lirik 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, wann.user.name, m)
	...
	if (tebaktebakan.hasOwnProperty(m.sender.split('@')[0]) && isCmd) {
            ...
            if (budy.toLowerCase() == jawaban) {
                await wann.sendButtonText(m.chat, [{ buttonId: 'tebak tebakan', buttonText: { displayText: 'Tebak Tebakan' }, type: 1 }], `🎮 Tebak Tebakan 🎮\n\nJawaban Benar 🎉\n\nIngin bermain lagi? tekan button dibawah`, wann.user.name, m)
...
wann.relayMessage(jid, order.message, { messageId: order.key.id})
}
        
        if (m.isGroup && !m.key.fromMe &&  db.data.chats[m.chat].antilink && !isCreator && !isGroupAdmins){
        if (budy.match(`https://chat.whatsapp.com`)) {
        wann.sendMessage(m.chat, {text: `*Antilink Group Terdeteksi*\n\nKamu Akan Dikeluarkan Dari Group ${groupMetadata.subject}`}, {quoted:m})
        ...
        wann.sendMessage(from, { caption: hg, location: { jpegThumbnail: await getBuffer(data.thumb) }, templateButtons: button, footer: `Pilih Salah Satu Button Dibawah⬇️`, mentions: [sender] })
        }).catch((e) => {
        wann.sendMessage(from, { text: mess.error }, { quoted: m })
        ownerNumber.map( i => wann.sendMessage(from, { text: `Send Play Error : ${e}` }))
        })
        }
...
🛒 𝗦𝗲𝗹𝗹 𝗜𝗻𝘃𝗲𝗻𝘁𝗼𝗿𝘆
 ...
 × ${prefix}sellemas
 × ${prefix}selldiamond`
        wann.sendMessage(from, { caption: hg, location: { jpegThumbnail: thumbrpg }, templateButtons: button, footer: `Rpg Game By wann`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
「 PROFILE 」
 ...
 • Xp :  ${getLevelingXp(sender)}/${reqXp}
「 RPG GAME 」`
        wann.sendMessage(from, { caption: hg, location: { jpegThumbnail: imgjoinrpg }, templateButtons: button, footer: `Rpg Game By wann`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
addDm(sender, d)
        ...
        wann.sendMessage(from, { caption: hg, location: { jpegThumbnail: imgslime }, templateButtons: button, footer: `Rpg Game By wann`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
wann.sendMessage(from, { caption: hg, location: { jpegThumbnail: imggoblin }, templateButtons: button, footer: `Rpg Game By wann`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
wann.sendMessage(from, { caption: hg, location: { jpegThumbnail: imgdevil }, templateButtons: button, footer: `Rpg Game By wann`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
wann.sendMessage(from, { caption: hg, location: { jpegThumbnail: imgbehemoth }, templateButtons: button, footer: `Rpg Game By wann`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
wann.sendMessage(from, { caption: hg, location: { jpegThumbnail: imgdemon }, templateButtons: button, footer: `Rpg Game By wann`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
wann.sendMessage(from, { caption: hg, location: { jpegThumbnail: imgdemonking }, templateButtons: button, footer: `Rpg Game By wann`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
async function replyTemplate(teks) {
                       ...
                       return wann.sendMessage(from, buttonMessage)
                }
...
var button = [
{"urlButton": {"displayText": "MyOwner⚡","url": `https://wa.me/6285817414657`}},
{"quickReplyButton": {"displayText": "Sewabot","id": 'sewabot'}},
{"quickReplyButton": {"displayText": "Donasi","id": 'donasi'}},
{"quickReplyButton": {"displayText": "Status Bot wann","id": 'ping'}}
		]
wann.sendMessage(from, { caption: teks, location: { jpegThumbnail: thumb }, templateButtons: button, footer: `Owner Bot : ${owner.length}`, mentions: [sender] })
        .catch ((err) => reply(err))
        }
...
try {
let cret = await wann.groupCreate(args.join(" "), [])
let response = await wann.groupInviteCode(cret.id)
...
https://chat.whatsapp.com/${response}
       `
wann.sendMessage(m.chat, { text:teks, mentions: await wann.parseMention(teks)}, {quoted:m})
} catch {
reply("Error!")
}
}
...
try {
reply(`// Created By wann\n` + 'case ' + `'${args[0]}'` + fs.readFileSync('./wann.js').toString().split(`case '${args[0]}'`)[1].split(turbrek)[0] + turbrek)
} catch {
...
wann.sendList(m.chat, `Haii *${pushname}*`, `Silahkan Pilih Di Bawah`, "CLICK", "Fitur Nulis By wann ", fejfjej, { quoted: m })
addCmd(command.slice(0), 1, commund)
break
case 'nuliskiri':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
.on('exit', () => {
wann.sendMessage(from, { image: fs.readFileSync('./Atak/FOTO/BUKU/setelahkiri.jpg')}, {quoted: m, caption: `Jangan Malas Kak...`})
})
}
addCmd(command.slice(0), 1, commund)
break
...
replyNya(mess.wait)
                ...
                .on('error', () => reply('error'))
                .on('exit', () => {
                wann.sendMessage(from, { image: fs.readFileSync('./Atak/FOTO/BUKU/setelahkanan.jpg')}, {quoted: m, caption: `Jangan Malas Kak...`})
                })
            }
            addCmd(command.slice(0), 1, commund)
                break
...
replyNya(mess.wait)
                ...
                .on('error', () => reply('error'))
                .on('exit', () => {
                wann.sendMessage(from, { image: fs.readFileSync('./Atak/FOTO/FOLIO/setelahkiri.jpg')}, {quoted: m, caption: `Jangan Malas Kak...`})
                })
            }
            addCmd(command.slice(0), 1, commund)
                break
...
replyNya(mess.wait)
                ...
                .on('exit', () => {
                wann.sendMessage(from, { image: fs.readFileSync('./Atak/FOTO/FOLIO/setelahkanan.jpg')}, {quoted: m, caption: `Jangan Malas Kak...`})
                })
            }
            addCmd(command.slice(0), 1, commund)
                break
...
wann.sendList(m.chat, `Haii *${pushname}*`, `Silahkan Pilih Di Bawah`, "CLICK", "Topup Game By wann ", secmmknya, { quoted: efff })
addCmd(command.slice(0), 1, commund)
break
case 'topup5':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
let message = await prepareWAMessageMedia({ image: fs.readFileSync('./Image/ovoatak.jpg') }, { upload: wann.waUploadToServer })
...
const isblocks = await wann.fetchBlocklist()
const isBlock = isblocks.includes(jidny)
texnr = `     「 Profile Inspector 」
▸ Number : ${jidny.split("@")[0]}
▸ Mention : @${jidny.split("@")[0]}
▸ Name : ${wann.getName(jidny)}
▸ Biography : ${jsonformat(await wann.fetchStatus(jidny).catch(() => {}))}
▸ Business : ${jsonformat(await wann.getBusinessProfile(jidny))}
...
▸ Blocatak : ${isBlock}`
try {
ppuser = await wann.profilePictureUrl(jidny, 'image')
} catch {
ppuser = 'https://i0.wp.com/www.gambarunik.id/wp-content/uploads/2019/06/Top-Gambar-Foto-Profil-Kosong-Lucu-Tergokil-.jpg'
}
wann.sendMessage(m.chat, { image: { url: ppuser }, caption: texnr, mentions: await wann.parseMention(texnr), contextInfo:{externalAdReply:{
...
teks += `\n*Total : ${ban.length}*`
wann.sendMessage(from, { text: teks.trim() }, 'extendedTextMessage', { quoted: m, contextInfo: { "mentionedJid": ban } })
addCmd(command.slice(0), 1, commund)
break
case 'ban':
...
replyNya(mess.wait)
arg = args.join(' ')
mee = await wann.downloadAndSaveMediaMessage(quoted)
const { TelegraPh } = require('./Lib/uploader')
mem = await TelegraPh(mee)
meme = `https://api.memegen.link/images/custom/-/${arg}.png?background=${mem}`
memek = await wann.sendImageAsSticker(m.chat, meme, m, { packname: global.packname, author: global.author })
...
if (!isPrem) return replyPremium(mess.premium)
                ...
                if (args[0] === "lagu") {
                    ...
                    wann.sendText(m.chat, `Judul Lagu Nya Apa??\n\nArtist : ${result.artist}\nWaktu : 60s`, msg).then(() => {
                    tebaklagu[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
                    })
                    await sleep(60000)
                    if (tebaklagu.hasOwnProperty(m.sender.split('@')[0])) {
                    console.log("Jawaban: " + result.jawaban)
                    wann.sendButtonText(m.chat, [{ buttonId: 'tebak lagu', buttonText: { displayText: 'Tebak Lagu' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebaklagu[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, wann.user.name, m)
                    delete tebaklagu[m.sender.split('@')[0]]
                    ...
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    wann.sendImage(m.chat, result.img, `Silahkan Jawab Soal Di Atas Ini\n\nDeskripsi : ${result.deskripsi}\nWaktu : 60s`, m).then(() => {
                    tebakgambar[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
                    })
                    await sleep(60000)
                    if (tebakgambar.hasOwnProperty(m.sender.split('@')[0])) {
                    console.log("Jawaban: " + result.jawaban)
                    wann.sendButtonText(m.chat, [{ buttonId: 'tebak gambar', buttonText: { displayText: 'Tebak Gambar' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebakgambar[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, wann.user.name, m)
                    delete tebakgambar[m.sender.split('@')[0]]
                    ...
                    console.log("Jawaban: " + result.jawaban)
                    wann.sendButtonText(m.chat, [{ buttonId: 'tebak kata', buttonText: { displayText: 'Tebak Kata' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebakkata[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, wann.user.name, m)
                    delete tebakkata[m.sender.split('@')[0]]
                    ...
                    console.log("Jawaban: " + result.jawaban)
                    wann.sendButtonText(m.chat, [{ buttonId: 'tebak kalimat', buttonText: { displayText: 'Tebak Kalimat' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebakkalimat[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, wann.user.name, m)
                    delete tebakkalimat[m.sender.split('@')[0]]
                    ...
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    wann.sendText(m.chat, `Ini Adalah Lirik Dari Lagu? : *${result.soal}*?\nWaktu : 60s`, m).then(() => {
                    tebaklirik[m.sender.split('@')[0]] = result.jawaban.toLowerCase()
                    })
                    await sleep(60000)
                    if (tebaklirik.hasOwnProperty(m.sender.split('@')[0])) {
                    console.log("Jawaban: " + result.jawaban)
                    wann.sendButtonText(m.chat, [{ buttonId: 'tebak lirik', buttonText: { displayText: 'Tebak Lirik' }, type: 1 }], `Waktu Habis\nJawaban:  ${tebaklirik[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, wann.user.name, m)
                    delete tebaklirik[m.sender.split('@')[0]]
                    ...
                    let result = anu[Math.floor(Math.random() * anu.length)]
                    wann.sendText(m.chat, `*Jawablah Pertanyaan Berikut :*\n${result.soal}*\nWaktu : 60s`, m).then(() => {
		    ...
		    caklontong_desk[m.sender.split('@')[0]] = result.deskripsi
                    ...
                    console.log("Jawaban: " + result.jawaban)
                    wann.sendButtonText(m.chat, [{ buttonId: 'tebak lontong', buttonText: { displayText: 'Tebak Lontong' }, type: 1 }], `Waktu Habis\nJawaban:  ${caklontong[m.sender.split('@')[0]]}\nDeskripsi : ${caklontong_desk[m.sender.split('@')[0]]}\n\nIngin bermain? tekan button dibawah`, wann.user.name, m)
                    delete caklontong[m.sender.split('@')[0]]
		    delete caklontong_desk[m.sender.split('@')[0]]
...
if (!isPrem) return replyPremium(mess.premium)
                ...
                wann.sendText(m.chat, `*Berapa hasil dari: ${result.soal.toLowerCase()}*?\n\nWaktu: ${(result.waktu / 1000).toFixed(2)} detik`, m).then(() => {
...
let message = await prepareWAMessageMedia({ image: hasil }, { upload: wann.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
imageMessage: message.imageMessage,
hydratedContentText: `Gelap Bos:v`,
hydratedFooterText: 'Created By wann',
hydratedButtons: [{
urlButton: {
displayText: 'MyGithub',
url: 'https://github.com/wannofc'
}
},
{
urlButton: {
...
let message = await prepareWAMessageMedia({ image: memeall }, { upload: wann.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
imageMessage: message.imageMessage,
...
let message = await prepareWAMessageMedia({ image: highschooldxd }, { upload: wann.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
imageMessage: message.imageMessage,
...
let message = await prepareWAMessageMedia({ image: swordartonline }, { upload: wann.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
imageMessage: message.imageMessage,
...
let message = await prepareWAMessageMedia({ image: lovelive }, { upload: wann.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
imageMessage: message.imageMessage,
...
if (!m.key.fromMe && !isCreator) return replyNya(mess.owner)
teks = '*List Premium*\n\n'
for (let wann of prem) {
teks += `- ${wann}\n`
}
teks += `\n*Total : ${prem.length}*`
wann.sendMessage(from, { text: teks.trim() }, 'extendedTextMessage', { quoted: m, contextInfo: { "mentionedJid": prem } })
addCmd(command.slice(0), 1, commund)
break
case 'addprem':
if (!m.isGroup) return replyNya(mess.group)
...
let a = await wann.sendMessage(from, { react: { text: "𝘿𝘿𝘿𝘿𝘿𝘿𝘿𝘿𝘿𝘿𝘿𝘿𝘿𝘿𝘿𝘿𝘿𝘿𝘿𝘿𝘿️", }}, { quoted : m })
wann.sendMessage(Pe, { text: "Oii kimoyasaaa" }, { quoted: m});
...
wann.sendMessage(m.chat, {audio: inicdd, mimetype:'audio/mpeg', ptt:true }, {quoted:m})
addCmd(command.slice(0), 1, commund)
break
case 'tts':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
wann.sendMessage(m.chat, {audio: { url: inimmk.result }, mimetype:'audio/mpeg', ptt:true }, {quoted:m})
addCmd(command.slice(0), 1, commund)
break
...
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
wann.sendContact(m.chat, global.owner, m)
}
addCmd(command.slice(0), 1, commund)
break
case 'credits':
const soko = "6285817414657@s.whatsapp.net"
...
const sokp = "6285817414657@s.whatsapp.net"
teksits = `「 *Thanks To* 」
🧐 Ridho @${soko.split("@") [0]}
🧐 Akira @${sokl.split("@")[0]}
🧐 Dinata @${sokd.split("@")[0]}
...
🧐 Iuszboy @${sokp.split("@")[0]}`
wann.sendMessage(m.chat, { image: ppnyauser, caption: teksits, contextInfo: {
"forwardingScore":999,
"isForwarded":true,
"mentionedJid": [soko, sokl, sokd, soka, sokdi, sokr, sokt, soky, soki, sokf, sokrz, sokha, sokyu, sokp],
"externalAdReply": {
"title": `Hai Kak ${pushname}👋🏻`, 
"mediaType": 2, 
"thumbnail": ppnyauser,
"previewType": "VIDEO",
"mediaUrl": 'https://chat.whatsapp.com/Hq6tAL2w3dqGgOrsL43VTV',
"sourceUrl": 'https://chat.whatsapp.com/Hq6tAL2w3dqGgOrsL43VTV'
}}}, { quoted: fakewann })
addCmd(command.slice(0), 1, commund)
break
...
wann.sendList(m.chat, `Haii *${pushname}*`, `Silahkan Pilih Di Bawah`, "CLICK", "Rpg Game By wann ", sectionnya, { quoted: fakewann})
addCmd(command.slice(0), 1, commund)
break
case 'slime':
case 'killslime':
...
fileName: `Bot By wann`, 
mimetype: `application/${byatak}`,
jpegThumbnail: thumb,
caption: mbc,
footer: `_Powered By @${botzatak.split("@")[0]}_`,
fileLength: "9", 
mentions:[sender, botzatak],
buttons: buttons,
headerType: 4,
contextInfo: {
"mentionedJid": [sender, botzatak],
"externalAdReply": {
...
wann.sendMessage(m.chat, buttonMessage, { quoted: {
				  key: {
				   fromMe: false,
				   participant: `0@s.whatsapp.net`,
				   remoteJid: "6281903153426-1626053991@g.us"
...
if (/webp/.test(mime)) {
wann.sendMessage(i, { sticker: { url: media } }, { quoted: m })
} else if (/image/.test(mime)) {
let junn = `*_BROADCAST IMAGE_*${text ? '\n\n' + text : ''}`
wann.send5ButImg(i, junn, `Created By wann`, buffer, butoon)
} else if (/video/.test(mime)) {
let junn = `*_BROADCAST VIDIO_*${text ? '\n\n' + text : ''}`
wann.send5Vid(i, junn, `Created By wann`, buffer, butoon)
} else if (/audio/.test(mime)) {
wann.sendMessage(i, {audio: buffer, mimetype: 'audio/mpeg'}, { quoted : m })
} else {
...
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
		...
		for (let yoi of anu) {
		    ...
		    let btn = [{
                      ...
                      wann.send5ButImg(yoi, txt, wann.user.name, global.thumb, btn)
		}
...
let btn = [{
                      ...
                      wann.send5Vid(m.chat, `Nih Kak`, wann.user.name, hasiltt, btn)
                      }
                      break
case 'asupan':
...
console.log(a2.url) 
wann.sendMessage(from, {video : { url : xm2.url }, caption : 'nih'}) 
...
console.log(a2.url) 
wann.sendMessage(from, {video : { url : a2.url }, caption : 'nih'}) 
} else if (q.toLowerCase() === "rikagusriani") {
const oi = geayubi
const jsonData = JSON.parse(oi);
const wann1 = Math.floor(Math.random() * jsonData.length);
const wann2 = jsonData[xm1];
console.log(wann2.url) 
wann.sendMessage(from, {video : { url : wann2.url }, caption : 'nih'}) 
} else {
...
wann.sendMessage(m.chat, { video: { url: hasiltod.result }, mimetype: 'video/mp4', fileName: `asupan.mp4`, caption: `Nih Asupan Nya` }, { quoted: fakewann })
}
break
case 'ghea':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
wann.sendMessage(m.chat, { video: { url: hasilwjd.result.url }, mimetype: 'video/mp4', fileName: `${command}.mp4`, caption: `Nih Asupan Nya` }, { quoted: fakewann })
}
break
case 'ukhty':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
wann.sendMessage(m.chat, { video: { url: hasifs.result.url }, mimetype: 'video/mp4', fileName: `${command}.mp4`, caption: `Nih Asupan Nya` }, { quoted: fakewann })
}
break
case 'santuy':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
wann.sendMessage(m.chat, { video: { url: hasily.result.url }, mimetype: 'video/mp4', fileName: `${command}.mp4`, caption: `Nih Asupan Nya` }, { quoted: fakewann })
}
break
case 'bokep':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
wann.sendMessage(m.chat, { video: dwhe, mimetype: 'video/mp4', fileName: `${command}.mp4`, caption: `Nih Bokep Nya` }, { quoted: fakewann })
}
break
case 'storyanime':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
wann.sendMessage(m.chat, { video: { url: hasiltod.result }, mimetype: 'video/mp4', fileName: `storyanime.mp4`, caption: `Nih Story Animenya` }, { quoted: fakewann })
}
break
case 'out':{
if (!isCreator) return replyNya(mess.owner)
...
wann.sendMessage(m.chat, { image: buffer }, { quoted: fakewann })
fs.unlinkSync(ran)
})
}
break
...
.then(({data}) => {
wann.sendImageAsSticker(m.chat, data.url, m, { packname: global.packname, author: global.author })
})
break
case 'attp':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
wann.sendMessage(m.chat, { sticker: gehdhe }, { quoted: fakewann })
break
case 'ttp':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
if (args.length == 0) return replyNya(`Contoh: ${prefix + command} Hai`)
veireuue = await getBuffer(`https://api.lolhuman.xyz/api/ttp?apikey=${lolkey}&text=${encodeURI(q)}`)
wann.sendMessage(m.chat, { sticker: veireuue }, { quoted: fakewann })
break
case 'tovideo': {
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
let encmedia = await wann.sendImageAsSticker(m.chat, titor, m, { packname: global.packname, author: global.author })
await fs.unlinkSync(encmedia)
break
case 'dadu':
case 'patrick':
...
wann.sendMessage(m.chat, { sticker: buffer }, { quoted: fakewann })
break
case 'faktaunik': 
case 'katabijak': 
case 'pantun': 
...
wann.sendMessage(m.chat, buttonMessage, { quoted: fakewann })
}
break
case 'quotes':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
wann.sendMessage(m.chat, {document: mnya, mimetype: 'application/zip', fileName: `${kfeh.result.filename}`}, {quoted:fakewann}).catch ((err) => reply(oh))
}
break
case 'iqra': {
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
wann.sendMessage(m.chat, {document: yy, mimetype: 'application/pdf', fileName: `iqra${text}.pdf`}, {quoted:fakewann}).catch ((err) => reply(oh))
}
break
...
if (args[0] === 'pdf') {
sticWait(from)
wann.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.pdf'}, mimetype: 'application/pdf', fileName: 'juz-amma-arab-latin-indonesia.pdf'}, {quoted:fakewann})
} else if (args[0] === 'docx') {
sticWait(from)
wann.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.docx'}, mimetype: 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', fileName: 'juz-amma-arab-latin-indonesia.docx'}, {quoted:fakewann})
} else if (args[0] === 'pptx') {
sticWait(from)
wann.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.pptx'}, mimetype: 'application/vnd.openxmlformats-officedocument.presentationml.presentation', fileName: 'juz-amma-arab-latin-indonesia.pptx'}, {quoted:fakewann})
} else if (args[0] === 'xlsx') {
sticWait(from)
wann.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.xlsx'}, mimetype: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', fileName: 'juz-amma-arab-latin-indonesia.xlsx'}, {quoted:fakewann})
} else {
...
let message = await prepareWAMessageMedia({ image: buff }, { upload: wann.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
imageMessage: message.imageMessage,
...
if (!isPrem) return replyPremium(mess.premium)
                    ...
                    await wann.sendMessage(m.chat, { image: eahdw, caption: ini_txt }, { quoted: fakewann})                  
                    break
...
sticWait(from)
                    ...
                    await wann.sendMessage(m.chat, { image: ini_buffer, caption: '*PINTEREST IMAGE*' }, { quoted: fakewann})                  
                    break
case 'pinterest2':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
if (!isPrem) return replyPremium(mess.premium)
                    ...
                    for (var x = 0; x <= 5; x++) {
                        ...
                        await await wann.sendMessage(m.chat, { image: ini_buffer, caption: '*PINTEREST IMAGE*' }, { quoted: fakewann})                  
                    }
                    break
case 'character':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
sticWait(from)
                    ...
                    await wann.sendMessage(m.chat, { image: gnejws, caption: ini_txt }, { quoted: fakewann})                  
                    break
case 'manga':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
if (!isPrem) return replyPremium(mess.premium)
...
sticWait(from)
                    ...
                    await wann.sendMessage(m.chat, { image: cehdhw, caption: ini_txt }, { quoted: fakewann})                  
                    break
case 'kusonime':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
if (!isPrem) return replyPremium(mess.premium)
...
let message = await prepareWAMessageMedia({ image: ini_buffer }, { upload: wann.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
imageMessage: message.imageMessage,
...
sticWait(from)
             ...
             let message = await prepareWAMessageMedia({ image: mvn }, { upload: wann.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
imageMessage: message.imageMessage,
...
pll = `Nih Kak シ︎`
let message = await prepareWAMessageMedia({ image: imagenya }, { upload: wann.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
imageMessage: message.imageMessage,
...
pll = `Nih Kak シ︎`
let message = await prepareWAMessageMedia({ image: dwruw }, { upload: wann.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
imageMessage: message.imageMessage,
...
case 'lava': case 'rock': case 'bloodglas': case 'hallowen': case 'darkgold': case 'joker': case 'wicker':
 case 'firework': case 'skeleton': case 'blackpink': case 'sand': case 'glue': case '1917': case 'leaves': {
             ...
             let anu = await maker.textpro(link, q)
                wann.sendMessage(m.chat, { image: { url: anu }, caption: `*Done*` }, { quoted: m })
             }
break
...
pll = `Nih Kak シ︎`
let message = await prepareWAMessageMedia({ image: imagetod }, { upload: wann.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
imageMessage: message.imageMessage,
...
sticWait(from)
                    ...
                    wann.sendMessage(m.chat, { image: ini_buffer, caption: `*KTP MAKER*` }, { quoted: fakewann})
                    break
case 'tiktokmaker':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
if (!isPrem) return replyPremium(mess.premium)
...
wann.sendButtonText(m.chat, buttons, `Selesai Mining🚧\nlist hasil :\nEmas : ${emas}🪙\nUang : $${pp}💰\nBesi : ${besi}⛓️\nBerlian : ${dm}💎`, wann.user.name, m)
}, 9000) // 1000 = 1s,
setTimeout( () => {
wann.sendMessage(from, { text: '🚧 Selesai Menguli . . .🪙👷' }, { quoted: fakewann })
}, 7000) // 1000 = 1s,
setTimeout( () => {
wann.sendMessage(from, { text: '🚧 Menemukan Emas . . .⚒️🏔️️️' }, { quoted: fakewann })
}, 4000) // 1000 = 1s,
setTimeout( () => {
wann.sendMessage(from, { text: '🚧 Mulai Menambang . . .⚒️🏔️️' }, { quoted: fakewann })
}, 1500) // 1000 = 1s,
setTimeout( () => {
wann.sendMessage(from, { text: mining }, {quoted: fakewann}) 
}, 0) // 1000 = 1s,
break
case 'inventori':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
wann.sendButtonText(m.chat, buttons_ridho_gay, `📍 𝗣𝗿𝗼𝗳𝗶𝗹𝗲 𝗣𝗹𝗮𝘆𝗲𝗿\n • Nama : ${pushname}\n • Rank : ${role}\n • Status : ${elit}\n • Xp : ${getLevelingXp(sender)}/${reqXp}\n • Level : ${getLevelingLevel(sender)}\n🎒 𝗜𝗻𝘃𝗲𝗻𝘁𝗼𝗿𝗶 :\n • Emas : ${getEmas(sender)}🪙\n • Uang : $${(getBalance(sender, balance))}💰\n • Besi : ${getBesi(sender)}⛓️\n • Berlian : ${getDm(sender)}💎\n • Ikan : ${getFish(sender)}🎣`, wann.user.name, m)
break
case 'sellikan':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
if (!isPrem) return replyPremium(mess.premium)
...
wann.sendButtonText(m.chat, buttons, `🛒 𝗣𝗔𝗦𝗔𝗥\n • Penjual : ${pushname}\n • Pembeli : Admin\n • Harga/Ikan : 5\n • Status : Sukses\n • Sisa Ikan : ${getFish(sender)}\n • Hasil Penjualan : $${rp}`,  wann.user.name, m)
break
case 'sellbesi':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
if (!isPrem) return replyPremium(mess.premium)
...
wann.sendButtonText(m.chat, buttons, `🛒 𝗣𝗔𝗦𝗔𝗥\n • Penjual : ${pushname}\n • Pembeli : Admin\n • Harga/Dm : 75\n • Status : Sukses\n • Sisa Diamond : ${getDm(sender)}\n • Hasil Penjualan : $${etoo}`, wann.user.name, m)
break 
case 'mancing':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
if (!isPrem) return replyPremium(mess.premium)
...
var button = [
        ...
        wann.sendMessage(from, { caption: hg, location: { jpegThumbnail: cing }, templateButtons: button, footer: `Rpg Game By wann`, mentions: [sender] })
        .catch ((err) => reply(mess.error))
}, 6000)
setTimeout( () => {
wann.sendMessage(from, { text: 'Berhasil Mendapatkan Ikan . . .' }, { quoted: fakewann })
}, 5000) // 1000 = 1s,
setTimeout( () => {
wann.sendMessage(from, { text: '🎣 Menarik Kail. . .' }, { quoted: fakewann })
}, 3000) // 1000 = 1s,
setTimeout( () => {
wann.sendMessage(from, { text: '🎣 Mulai Memancing . . .' }, { quoted: fakewann })
}, 1500) // 1000 = 1s,
...
var button = [
        ...
        var hg = `「 DEATH 」\n\n • Tempat  ${ad}\n • MONEY : $${money}\n • EXP : ${adven}Xp`
        wann.sendMessage(from, { caption: hg, location: { jpegThumbnail: hasm }, templateButtons: button, footer: `Rpg Game By wann`, mentions: [sender] })
        .catch ((err) => reply(mess.error))
}, 7000)
setTimeout( () => {
wann.sendMessage(from, { text: `Awass` }, { quoted: fakewann })
}, 5000) // 1000 = 1s,
setTimeout( () => {
wann.sendMessage(from, { text: `Tiba Tiba Ada ${sesuatu}` }, { quoted: fakewann })
}, 3000) // 1000 = 1s,
setTimeout( () => {
wann.sendMessage(from, { text: `${pushname} Sedang Bertualang` }, { quoted: fakewann })
}, 1500) // 1000 = 1s,
...
wann.sendButtonText(m.chat, buttons, `🎰 Lucky\n• Uang : $${b}\n• Emas : ${a}\n• Besi : ${c}\n• Xp : ${ez}`, wann.user.name, m)
}
break
case 'cecan2':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
pll = `Nih Kak シ︎`
let message = await prepareWAMessageMedia({ image: { url: imgd.result.url } }, { upload: wann.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
imageMessage: message.imageMessage,
...
sticWait(from)  
wann.ev.on('group-participants.update', async (anu) => {
console.log(anu)  
...
wann.sendButtonText(anu.id, buttons, `Hai saya Wann Bot`, wann.user.name, m)
...
await wann.sendButtonText(m.chat, buttons, `Mode Antilink`, wann.user.name, m)
}
break
case 'antiwame':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
case 'addowner': {
  ...
  if (!who) return replyNya(`tag orangnya!`)
    if (global.owner.includes(who.split`@`[0])) return replyNya('dia udah menjadi owner !')
...
case 'delowner': { 
  ...
  if (!who) return replyNya(`tag orangnya!`)
	...
	ya = `${who.split`@`[0]}`
	unp = global.owner.indexOf(ya)
  global.owner.splice(unp, 1)
  replyNya(`Berhasil`)
}
break
case 'autosticker':
...
await wann.sendButtonText(m.chat, buttons, `Mode Autosticker`, wann.user.name, m)
}
					break
...
if (args[0] === 'close'){
await wann.groupSettingUpdate(m.chat, 'announcement').then((res) => replyNya(`Sukses Menutup Group`)).catch((err) => reply(jsonformat(err)))
} else if (args[0] === 'open'){
await wann.groupSettingUpdate(m.chat, 'not_announcement').then((res) => replyNya(`Sukses Membuka Group`)).catch((err) => reply(jsonformat(err)))
} else {
let buttons = [
{ buttonId: 'group open', buttonText: { displayText: 'Open' }, type: 1 },
{ buttonId: 'group close', buttonText: { displayText: 'Close' }, type: 1 }
]
await wann.sendButtonText(m.chat, buttons, `Mode Group`, wann.user.name, m)
}
}
break
case 'welcome': {
...
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
if (args.length < 1) return replyNya(`Contoh : ${prefix + command} wann`)
cantik = body.slice(1)
...
wann.sendMessage(m.chat, { text: `${yn}%` }, { quoted: fakewann })
break
case 'jadian': {
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
if (!m.isGroup) throw mess.group
...
var media = await wann.downloadAndSaveMediaMessage(quoted, 'ppbot.jpeg')
if (args[0] == `'panjang'`) {
...
var memeg = await wann.updateProfilePicture(m.chat, { url: media })
fs.unlinkSync(media)
reply(`Sukses`)
}
}
...
var memeg = await wann.updateProfilePicture(botNumber, { url: media })
fs.unlinkSync(media)
reply(`Sukses`)
}
}
...
wann.sendMessage(m.chat, { text: teks, mentions: participants.map(a => a.id) }, { quoted: fakewann })
}
break
case 'hidetag': {
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
if (!m.isGroup) throw mess.group
if (!isAdmins) throw mess.admin
wann.sendMessage(m.chat, { text : q ? q : '' , mentions: participants.map(a => a.id)}, { quoted: fakewann })
}
break
case 'promote': {
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
sticWait(from)
                    ...
                    wann.sendMessage(m.chat, { image: fol, caption: ini_txt }, { quoted: fakewann})                  
                    get_audio = await getBuffer(ani.audio[0].link)
                    wann.sendMessage(m.chat, {audio: get_audio, mimetype: 'audio/mpeg', fileName: `${ani.title}.mp3`}, { quoted : fakewann })
                    break
case 'play':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
if (!isPrem) return replyPremium(mess.premium)
...
wann.sendMessage(m.chat, { audio: { url: media.dl_link }, mimetype: 'audio/mp4', ptt:true, contextInfo:{externalAdReply:{
                title: `Hai Kak ${pushname}`,
                body: `© 2022`,
                thumbnail: thumb,
mediaType:2,
...
if (!q) throw `Link Nya?`
sticWait(from)
wann.sendMessage(from, { image: { url: `https://api.lolhuman.xyz/api/ssweb?apikey=${lolkey}&url=${q}`}})
break
case 'xnxxsearch':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
if (!isPrem) return replyPremium(mess.premium)
...
wann.sendMessage(from, { text: anu }, { quoted: fakewann })
break
              case 'spotifysearch':
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
              if (!isPrem) return replyPremium(mess.premium)
...
sticWait(from)
                    ...
                    await wann.sendMessage(m.chat, { image: fott, caption: ini_txt }, { quoted: fakewann})                  
                    break
...
wann.sendMessage(from, { audio: { url: res.nowm }, mimetype: 'audio/mp4', ptt:true, contextInfo:{externalAdReply:{
title: `Hai Kak ${pushname}`,
...
title: a.title, description: `Channel: ${a.author.name} | Durasi: ${a.duration}`, rowId: `${prefix}play ${a.url}`
    ...
    const button = {
        ...
        wann.relayMessage(m.chat, templateList.message, { messageId: templateList.key.id });
break
case 'hentai':
case 'ahegao':
case 'ass':
...
wann.sendMessage(m.chat, { image: { url: random }, caption: `Nih Kak` }, { quoted: fakewann })
}
break
...
wann.sendMessage(m.chat, { image: { url: random.male }, caption: `Foto Couple Male` }, { quoted: fakewann })
wann.sendMessage(m.chat, { image: { url: random.female }, caption: `Fofo Couple Female` }, { quoted: fakewann })
}
break
case 'tiktokstalk':{
if (isBan) return replyBan('Maaf Kamu Sudah Di Ban Silahkan Chat Owner Di Bawah Untuk Membuka Nya')
...
let message = await prepareWAMessageMedia({ image: buffer }, { upload: wann.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
imageMessage: message.imageMessage,
...
wann.sendMessage(m.chat, { image: thumbnail, caption: ini_txt }, { quoted: fakewann})
break
case 'gsmarena': {
...
⭔ Detail: ${detail}`
            wann.sendImage(m.chat, thumb, capt, m)
            }
            break
            case 'jadwalbioskop': {
            ...
            wann.sendImage(m.chat, res.result[0].thumb, capt, m)
            }
            break
            ...
            wann.sendImage(m.chat, res.result[0].img, capt, m)
            }
            break
            case 'aminio': {
            ...
            wann.sendImage(m.chat, 'https://'+res.result[0].community_thumb, capt, m)
            }
            break
            case 'wattpad': {
            ...
            wann.sendImage(m.chat, res.result[0].thumbnail, capt, m)
            }
            break
...
let message = await prepareWAMessageMedia({ image: wehw }, { upload: wann.waUploadToServer })
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
templateMessage: {
hydratedTemplate: {
imageMessage: message.imageMessage,
...
case 'anonymous': {
				...
				let buttons = [{
                                urlButton: {
                                    ...
                                    url: 'https://wa.me/6285817414657?text=bang+report+bug'
                                }
                            }, {
                                quickReplyButton: {
                ...
                wann.sendButtonText(m.chat, buttons, `\`\`\`Hi ${await wann.getName(m.sender)} Welcome To Anonymous Chat\n\nKlik Button Dibawah Ini Untuk Mencari Partner\`\`\``, wann.user.name, m)
            }
			break
case 'sendkontak': case 'sendcontact': {
                ...
                if (!room) {
                    ...
                    await wann.sendButtonText(m.chat, buttons, `_Kamu Sedang Tidak Berada Di Sesi Anonymous, Tekan Button Untuk Mencari Partner_`)
                    throw false
                }
                let profile = await wann.profilePictureUrl(room.b)
                let status = await wann.fetchStatus(room.b)
                let msg = await wann.sendImage(room.a, profile, `Nama : ${await wann.getName(room.b)}\nBio : ${status.status}\nUser : @${room.b.split("@")[0]}`, m, { mentions: [room.b] })
            ...
            case 'keluar': case 'leave': {
                ...
                if (other) await wann.sendText(other, `_Partner Telah Meninggalkan Sesi Anonymous_`, m)
            ...
            case 'mulai': case 'start': {
                ...
                if (Object.values(this.anonymous).find(room => room.check(m.sender))) {
                    ...
                    await wann.sendButtonText(m.chat, buttons, `_Kamu Masih Berada Di dalam Sesi Anonymous, Tekan Button Dibawah Ini Untuk Menghentikan Sesi Anonymous Anda_`, wann.user.name, m)
                    throw false
                }
                ...
                if (room) {
                    ...
                    await wann.sendButtonText(room.a, buttons, `_Berhasil Menemukan Partner, sekarang kamu dapat mengirim pesan_`, wann.user.name, m)
                    room.b = m.sender
                    room.state = 'CHATTING'
                    await wann.sendButtonText(room.b, buttons, `_Berhasil Menemukan Partner, sekarang kamu dapat mengirim pesan_`, wann.user.name, m)
                } else {
                    let id = + new Date
                    this.anonymous[id] = {
                        id,
                    ...
                    await wann.sendButtonText(m.chat, buttons, `_Mohon Tunggu Sedang Mencari Partner_`, wann.user.name, m)
                }
                break
            }
            case 'next': case 'lanjut': {
                ...
                if (!romeo) {
                    ...
                    await wann.sendButtonText(m.chat, buttons, `\`\`\`Kamu Sedang Tidak Berada Di Sesi Anonymous, Tekan Button Untuk Mencari Partner\`\`\``)
                    throw false
                }
                let other = romeo.other(m.sender)
                if (other) await wann.sendText(other, `\`\`\`Partner Telah Meninggalkan Sesi Anonymous\`\`\``, m)
                ...
                if (room) {
                    ...
                    await wann.sendButtonText(room.a, buttons, `\`\`\`Berhasil Menemukan Partner, sekarang kamu dapat mengirim pesan\`\`\``, wann.user.name, m)
                    room.b = m.sender
                    room.state = 'CHATTING'
                    await wann.sendButtonText(room.b, buttons, `\`\`\`Berhasil Menemukan Partner, sekarang kamu dapat mengirim pesan\`\`\``, wann.user.name, m)
                } else {
                    let id = + new Date
                    this.anonymous[id] = {
                        id,
                    ...
                    await wann.sendButtonText(m.chat, buttons, `\`\`\`Mohon Tunggu Sedang Mencari Partner\`\`\``, wann.user.name, m)
                }
                break
}
...
case 'catalog': {
if (!isCreator) return
var messa = await prepareWAMessageMedia({ image: fs.readFileSync('./Image/img/devil.jpg') }, { upload: wann.waUploadToServer })
...
wann.relayMessage(m.chat, catalog.message, { messageId: catalog.key.id })
}
break			
case 'list':
...
wann.sendMessage(from, listMessage, {quoted:m})
} catch {
